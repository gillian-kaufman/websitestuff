...
<html>
  ...
  <body>
    ...
    <p>Select a Month/Year Combination</p>
    ...
    <?php
      ...
      for ($count=0; $count < (6*7); $count++) 
      {
        ...
        else 
        {
          ...
          $chkEvent_sql = "SELECT event_title FROM calendar_events WHERE userid='".$_SESSION['id']."' AND month(event_start) = '".$month."' AND dayofmonth(event_start) = '".$dayArray['mday']."' AND year(event_start) = '".$year."' ORDER BY event_start";
